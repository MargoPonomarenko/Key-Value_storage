...
else:unix: LIBS += -L$$PWD/../../build-Key-Value_Storage-Desktop_Qt_6_3_1_MinGW_64_bit-Debug/ -lKey-Value_storage

INCLUDEPATH += "C:\Users\margo\Documents\QTprojects\Key-Value_storage"

DEPENDPATH += $$PWD/../../build-Key-Value_Storage-Desktop_Qt_6_3_1_MinGW_64_bit-Debug/debug
